    ...
    public static class Reduce extends Reducer<Text, Text, Text, Text> {
        ...
        protected void cleanup(Context context) throws IOException, InterruptedException {
            if (rowCount > 0) {
                ...
                context.write(new Text("Total Subscribers Count: "), new Text(sumSubscribers.toString()));
                context.write(new Text("Total Avg Views Count: "), new Text(sumAvgViews.toString()));
                context.write(new Text("Total Avg Likes Count: "), new Text(sumAvgLikes.toString()));
                context.write(new Text("Total Avg Comments Count: "), new Text(sumAvgComments.toString()));
            }
        }
    }
